...
//
//     final scheduleAppointmentModel = scheduleAppointmentModelFromJson(jsonString);

import 'dart:convert';

List<AppointmentScheduleModel> scheduleAppointmentModelFromJson(String str) =>
    List<AppointmentScheduleModel>.from(
        json.decode(str).map((x) => AppointmentScheduleModel.fromJson(x)));

String scheduleAppointmentModelToJson(List<AppointmentScheduleModel> data) =>
