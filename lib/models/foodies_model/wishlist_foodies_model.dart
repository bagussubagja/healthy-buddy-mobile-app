...
List<WishlistFoodiesModel> wishlistFoodiesModelFromJson(String str) =>
    List<WishlistFoodiesModel>.from(
        json.decode(str).map((x) => WishlistFoodiesModel.fromJson(x)));

String wishlistFoodiesModelToJson(List<WishlistFoodiesModel> data) =>
...
class WishlistFoodiesModel {
  ...
  factory WishlistFoodiesModel.fromJson(Map<String, dynamic> json) =>
      WishlistFoodiesModel(
        id: json["id"],
        idUser: json["id_user"],
